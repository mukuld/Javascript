            ...
            async function getObjectFromBucket(s3Client, bucketName, objectKey) {
                try {
                    ...
                    let convertedArray = [objectData];
                    //convertedArray = removeSingleQuotes(JSON.stringify(convertedArray));
                    console.log("Converted Array is: ", convertedArray);
                    //let formattedRecord = {records: convertedArray};
                    //formattedRecord = JSON.stringify(formattedRecord);
                    //console.log("Formatted Record:", formattedRecord);
                    //let cleanformattedRecord = removeSingleQuotes(formattedRecord);
